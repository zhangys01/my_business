...
public class R0Meta {
    ...
    public static  synchronized File generateR0Meta(WorkflowOrder order, String jobTaskId, File signalFile) throws Exception {
       ...
       sb.append("  <ReceiveEndTime>" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(ds[1].getTime() + 8 * 60 * 60 * 1000) + "</ReceiveEndTime>\n");
        ...
        logger.info(meta.toString()+"this is meta.xml");
        try {
