...
import com.business.business.entity.L1Product;
...
public class OracleProcessInfoImpl {
    ...
    public void insertL0Data(L0DATA l0DATA)throws Exception{
        ...
        try {
            ...
            ps.setString(3,l0DATA.getORBIT());
    ...
    public void insertL1product(L1Product l1)throws Exception{
    ...
    public void insertL2product(L1Product l2)throws Exception{
